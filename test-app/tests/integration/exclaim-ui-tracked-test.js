...
module('Integration | Component | ExclaimUi | tracked env', function (hooks) {
  ...
  test('it extends the environment and propagates changes', async function (assert) {
    ...
    components.root.args.config.global = 'updated from root binding';
    await settled();
    ...
    components.root.args.env.global = 'updated from root env';
    await settled();
    ...
    components.first.args.config.global = 'updated from child binding';
    await settled();
    ...
    components.first.args.env.global = 'updated from child env';
    await settled();
    ...
    components.first.args.config.self = 'updated first';
    await settled();
  ...
  test('it invokes @onChange when root environment fields change', async function (assert) {
    ...
    lastChange = null;
    components.root.args.config.b = 'Ralph';
    await settled();
    ...
    lastChange = null;
    components.child.args.config.b = 'Nancy';
    await settled();
    ...
    lastChange = null;
    components.child.args.config.c = 'maybe';
    await settled();
    ...
    lastChange = null;
    components.child.args.config.d = 'maybe';
    await settled();
